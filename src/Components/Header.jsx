        ...
        <section className="flex flex-col justify-between h-screen">
            <div className="flex items-center justify-between w-full px-4 lg:max-w-7xl mx-auto">
                ...
                <div className="flex gap-4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hidden">
                        <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
                    </svg>
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp" className="svg-inline--fa fa-whatsapp fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 448 512" >
            ...
            <div className="flex -mt-10 relative">
                ...
                <ul className="ml-auto mr-8 space-y-5 absolute right-8">
                    <li className="w-7 text-[#b0b2c3] hover:text-white">
                    ...
                    <li className="w-7 text-[#b0b2c3] hover:text-white">
                        <a href="mailto:jidanjiyaj03@gmail.com" target="_blank">
